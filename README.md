...
* Import the BMC Remedy ITSM - Incident Communication Plan [BMCRemedyITSMIncident.zip](BMCRemedyITSMIncident.zip). For assistance, see the help article [here](http://help.xmatters.com/OnDemand/xmodwelcome/communicationplanbuilder/exportcommplan.htm)
